...
public class GsonCollectionRequest<T> extends Request<Collection<T>> {
    ...
    public Map<String, String> getHeaders() throws AuthFailureError {
        ...
        // Default headers
        headers.put("TIMEZONE", String.valueOf(SplurgeApi.offsetFromUtc()));
        headers.put("Accept-Language", SplurgeApi.acceptLanguage());
        return headers;
    }
    ...
    protected Response<Collection<T>> parseNetworkResponse(NetworkResponse response) {
        try {
            ...
            return Response.success((Collection<T>) SplurgeGson.getInstance().fromJson(je, mType),
