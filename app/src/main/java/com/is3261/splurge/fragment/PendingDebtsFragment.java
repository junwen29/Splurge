...
import com.is3261.splurge.async_task.LoadDebtsTask;
 ...
 */
public class PendingDebtsFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private LoadDebtsTask mTask = null;
    ...
    private void loadDebts(){
        ...
        if (mTask == null){
            ...
            mTask = new LoadDebtsTask(getContext(), mListener, mUserId);
