package com.is3261.splurge.receiver;
...
//        TaskStackBuilder stackBuilder = TaskStackBuilder.create(context);
        ...
        //enter debt activity directly
        else if (itemType.equals("expenses")) {
            Long expenseId = Long.parseLong(extras.getString("item_id", "0"));
            if (expenseId != 0) {

                notificationIntent = new Intent(context, DebtActivity.class);
                eventLabel = latest;
            }
        }
        ...
        if (notificationIntent == null) {
            notificationIntent = new Intent(context, TripActivity.class);
