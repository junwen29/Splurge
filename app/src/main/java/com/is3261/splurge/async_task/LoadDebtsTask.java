 ...
 */
public class LoadDebtsTask extends AsyncTask<Void,Void,Void> {

    private Context mContext;
    private CollectionListener<Expense> mListener;
    private String mUserId;

    public LoadDebtsTask(Context mContext, CollectionListener<Expense> mListener, String mUserId) {
    ...
    protected Void doInBackground(Void... params) {
        try {
            ...
            Thread.sleep(2000);
            SplurgeApi.getInstance(mContext).enqueue(ExpenseRequest.debts(mUserId, mListener));
