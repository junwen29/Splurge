package com.is3261.splurge.service;
...
import com.is3261.splurge.api.request.SettingsRequest;
...
public class UpdateServerService extends Service {
    ...
    public static final String UPDATE_DEVICE_TOKEN = "com.splurge_android.UPDATE_DEVICE_TOKEN";
    ...
    private void registerDeviceToken(final int stopId, String token) {
        SplurgeApi.getInstance(this).enqueue(SettingsRequest.registerDeviceToken(token, new EmptyListener() {
            @Override
    ...
    private void unregisterDeviceToken(final int stopId, String token) {
        SplurgeApi.getInstance(this).enqueue(SettingsRequest.unregisterDeviceToken(token, new EmptyListener() {
            @Override
            public void onResponse() {
