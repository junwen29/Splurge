...
public class RecordTripActivity extends Activity implements View.OnClickListener {

    private static final String TAG = "RecordTripActivity";
    ...
    public static Intent getStartIntent(Context context, MenuCategory menuCategory) {
        Intent starter = new Intent(context, RecordTripActivity.class);
